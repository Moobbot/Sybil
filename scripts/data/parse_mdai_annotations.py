...
ANNOT_COMMENTS = pd.read_csv(
    "/Mounts/rbg-storage1/datasets/NLST/mdai/annotation_comments_12062020.csv"
)
...
parser.add_argument(
    ...
    default="/Mounts/rbg-storage1/datasets/NLST/mdai/mdai_mit_project_poBGbqle_annotations_labelgroup_all_2020-11-25-030811.json",
)
parser.add_argument(
...
if __name__ == "__main__":
    ...
    USERS = {user["id"]: user["name"]
             for user in annotation_metadata_json["users"]}
    ...
    for dataset_dict in annotation_metadata_json["datasets"]:
        for annotation_meta_dict in tqdm(dataset_dict["annotations"]):
            ...
            annotation_dict[series_id][img_id].append(
                annotation_meta_dict["data"])
