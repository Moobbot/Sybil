...
from sybil.datasets.utils import LOAD_FAIL_MSG, METAFILE_NOTFOUND_ERR, order_slices
...
class CSVDataset(data.Dataset):
    ...
    def __init__(self, args, split_group):
        ...
        if args.img_file_type == "dicom":
            self.input_loader = DicomLoader(
                args.cache_path, augmentations, args)
        else:
            self.input_loader = OpenCVLoader(
                args.cache_path, augmentations, args)
    ...
    def create_dataset(self, split_group):
        ...
        for mrn_row in tqdm(self.dataset_dicts, position=0):
            ...
            dataset.append(
                {"serie": series_object, "exam": mrn_row["unique_id"]})
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            warnings.warn(LOAD_FAIL_MSG.format(
                sample["paths"], traceback.print_exc()))
